...
const AICopilot: React.FC = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      const apiKey = (window as any).__GEMINI_KEY__ || process.env.API_KEY || (import.meta as any).env?.VITE_GEMINI_API_KEY;
      ...
      const res = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${apiKey}`, {
        ...
        body: JSON.stringify({
          system_instruction: { parts: [{ text: SYSTEM_PROMPT + buildContext() }] },
