-- Applied to production on 2026-08-24 after the hardened frontend cutover.
-- Remove obsolete anonymous direct-table token paths and privatize Discovery storage.
